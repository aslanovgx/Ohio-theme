...
const Navbar = () => {
  function OpenNavbar() {
    ...
    const Mobile_Section = document.querySelector("#nav1_mobile");
    // const Nav_Section = document.querySelector('#nav1')
    Mobile_Section.style.transform = "translateX(0px)";
    // console.log(BarBtn);
  }
  function CloseNavbar() {
    const CloseBtn = document.querySelector("#close_btn");
    const Mobile_Section = document.querySelector("#nav1_mobile");
    Mobile_Section.style.transform = "translateX(-100%)";
    ...
    <>
            ...
            <div className="col-lg-2">
              <div className="nav1_left">
                <div className="nav1_icon">
                  <HiOutlineBars2 id="bar_btn" onClick={OpenNavbar} />
                </div>
                <img
                ...
                <li id="element_li">
                  ...
                  <div className="elements_hover elm">
                    ...
                    <ul>
                      ...
                      <li className="after_new">
                        Slider with Centered Details
                      </li>
                    </ul>
                    <ul>
      ...
      <nav id="nav1_mobile">
        <ul>
          ...
          <ul className="elements_portfolio">
            <li></li>
            <li>Widgets</li>
            <li>Widgets</li>
            <li>Widgets</li>
